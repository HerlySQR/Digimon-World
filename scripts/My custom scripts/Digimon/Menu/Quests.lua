...
OnInit("Quests", function ()
    ...
    local function InitFrames()
        ...
        AddButtonToTheRight(QuestButton, 8)
        ...
        BlzFrameSetAbsPoint(QuestMenu, FRAMEPOINT_TOPLEFT, GetMaxScreenX() - 0.25, 0.390000)
        ...
        BlzFrameSetPoint(Quests, FRAMEPOINT_TOPLEFT, QuestMenu, FRAMEPOINT_TOPLEFT, 0.015000, -0.030000)
