...
BlzFrameSetAbsPoint(BackpackMenu, FRAMEPOINT_TOPLEFT, 0.675000, 0.370000)
...
BlzFrameSetPoint(BackpackItemT[0], FRAMEPOINT_TOPLEFT, BackpackItems, FRAMEPOINT_TOPLEFT, 0.0000, -0.025000)
